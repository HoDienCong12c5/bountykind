...
var ImgCrop = React.forwardRef(function (props, ref) {
    ...
    var getComponent = function (titleOfModal) { return (React__default["default"].createElement(React__default["default"].Fragment, null,
        uploadComponent,
        image && (React__default["default"].createElement(AntModal__default["default"], __assign({ visible: true, wrapClassName: "".concat(PREFIX, "-modal ").concat(modalClassName || ''), title: titleOfModal, onOk: onOk, onCancel: onCancel, maskClosable: false, destroyOnClose: true }, modalProps),
    ...
    return (React__default["default"].createElement(LocaleReceiver__default["default"], null, function (locale, code) {
