...
import { validateNumber, countDots } from 'common/function'
import './style.scss'

const PriceInput = ({ value = '', suffix = '', onChange, isError = false, errorMessage = '', onlyInteger = false, placeholder = '0.000', maxDecimals = 8 }) => {
